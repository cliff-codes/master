               ...
               {/* Breaking the form items into two sections */}
                <section className='flex flex-1 flex-col gap-4'>
                    ...
                    <div className='w-full flex place-items-center gap-3 mt-1 '>
                        ...
                        <input type="text" placeholder="budget id" className="input input-bordered w-full max-w-sm focus:outline-none focus:border-slate-800"  />
                    </div>
            ...
            <form className='w-full px-3 mt-4 lg:flex gap-20'>
                <div className='w-full'>
                    ...
                    <div className='mt-4 w-full'>
                        ...
                        <textarea className="textarea textarea-bordered w-full max-w-lg h-32 focus:outline-none focus:border-slate-800" placeholder="description"></textarea>
                    </div>
                    ...
                    <button className='btn w-full mt-4 btn-success text-slate-50'>Add Item</button>
                </div>
            </form>
        </div>
    </div>
