...
const BudgetOwnerSuppliersPage = () => {
    return (
        <div className='px-4 mt-2'>
            <h1 className='font-medium'>Suppliers Lists</h1>
    
            <div className='w-full flex justify-end'>
                <Link href={'/super-admin/suppliers/budget-owner/addSupplier'}><button className='btn btn-sm'>Add Supplier</button></Link>
            </div>
            <div className="overflow-x-auto mt-2">
                <table className="table hover ">
                    ...
                    <tr className="hover">
                        ...
                        <td>Kumasi</td>
                        <td>
                            <Link href={'/super-admin/suppliers/budget-owner/{id}'}>
...
export default BudgetOwnerSuppliersPage